...
//            return driver.findElement(By.xpath("//table[@id='"+gridMap.get(tabName)+"']/descendant::th[normalize-space(@aria-label)='"+header+"']")).isDisplayed();
    ...
    private void initializeMaps() {
        ...
        // Help Desk Tabs
        gridMap.put("incomingwotab", "tabbtnincoming");
        gridMap.put("incomingwo","dtincoming");
        gridMap.put("pendingwotab", "tabbtnimportantinstructions");
        gridMap.put("pendingwo","dtimportantinstructions");
        gridMap.put("completedwotab", "tabbtncompleted");
        gridMap.put("completedwo", "dtcompleted");
        gridMap.put("discardedwotab", "tabbtndiscarded");
        gridMap.put("discardedwo", "dtdiscarded");
